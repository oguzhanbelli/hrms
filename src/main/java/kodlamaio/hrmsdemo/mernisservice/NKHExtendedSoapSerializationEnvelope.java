...
public class NKHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NKHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NKHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NKHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NKHDateTimeConverter dateTimeConverter = new NKHStandardDateTimeConverter();

    public NKHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NKHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NKHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NKHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NKHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NKHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
