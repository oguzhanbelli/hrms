...
public class NKHKPSPublicSoap
{
    ...
    public NKHKPSPublicSoap(){}

    public NKHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NKHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NKHExtendedSoapSerializationEnvelope envelope= new NKHExtendedSoapSerializationEnvelope(NKHExtendedSoapSerializationEnvelope.VER11);
